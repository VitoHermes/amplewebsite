...
const HomeNews = () => {
    return (
        <div className="w-full flex flex-col items-center justify-center mt-10 gap-10 px-12">
            <h1 className="text-4xl font-bold text-center text-black">Recent News</h1>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 w-[95%] justify-center overflow-hidden">
